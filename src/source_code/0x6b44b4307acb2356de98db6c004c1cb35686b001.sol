...
/* ============ Constructor ============ */
    ...
    */
    ...
    {    
        ...
        if (_setToken.getTotalComponentRealUnits( component ) == int256(_quantity)) {
            _setToken.editDefaultPositionUnit(component, int256(0));
    ...
    */
        ...
        whenLockedOnlyManager(_setToken)
    {
        ...
        if (!_setToken.isComponent( component )) {
            _setToken.addComponent(component);
            _setToken.editDefaultPositionUnit(component, int256(_quantity));
        } else {
            _setToken.editDefaultPositionUnit(component, int256(_quantity).add(
                _setToken.getTotalComponentRealUnits( component )) 
            );
        }
