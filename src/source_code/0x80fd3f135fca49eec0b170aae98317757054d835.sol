...
contract StakeTokenWrapper {
    ...
    uint256 public DEFLATION_OUT = 10;
    uint256 public DEFLATION_REWARD = 100;
    ...
    function withdraw(uint256 amount) public virtual {
        ...
        stakeToken.safeTransfer(address(0xdEaD), burnAmount);
...
contract YFOSDeflationStake is
    StakeTokenWrapper(0xCd254568EBF88f088E40f456db9E17731243cb25),
    IGovernanceAddressRecipient
{
    ...
    function getReward() public updateReward(msg.sender) checkStart {
        ...
        if (reward > 0) {
            ...
            stakeToken.safeTransfer(address(0xdEaD), deflationReward);
