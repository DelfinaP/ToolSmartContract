 ...
 */
contract IQToken is Context, ReentrancyGuard, IERC20, Ownable {
    ...
    function mint(address to, uint256 amount) public override nonReentrant {
        require(canMint[_msgSender()] == true, "Caller not a minter");
        _mint(to, removeFee(amount));
    }
    ...
    function setFee(uint256 newFee) public onlyOwner {
        require(newFee >= 0.5e18, "Fee cannot be more than 50%");
        require(newFee <= 1e18, "Fee cannot be negative");
        _fee = newFee;
    }
