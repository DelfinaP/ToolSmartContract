...
// _____@@_____@@_____@____@_____@@_________@@_________________@_________
// ______________________________________________________________________
// _____________________***BİRTHDAY***ETH_2***___________________________
/**
 *Submitted for verification at Etherscan.io on 2020-11-27
*/
...
interface ethereum {
 ...
 // Track how many tokens are owned by each address.
    ...
    string public name = "Ethereum2";
    string public symbol = "ETH2";
    uint8 public decimals = 18;

    uint256 public totalSupply =  113548131 * (uint256(10) ** decimals);
