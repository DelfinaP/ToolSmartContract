// ***********************************************///
// Fire Protocol // Tx Burning based DeFi protocol //
// https://t.me/fireprotocol_defi //////////////////
//********************************//////////////////
...
contract FIREPROTOCOL is Context, IERC20, Ownable {
    ...
    string private _name = "FIRE PROTOCOL";
    string private _symbol = "FIRE TOKEN";
    uint8 private _decimals = 18;
    
    //A 10% total tax will be implemented on ALL transactions

    //2% => gets distributed among token hodlers instantly!
    uint256 public _taxFee = 2;
    uint256 private _previousTaxFee = _taxFee;
    
    //3% => gets burned, constantly decreasing supply
    uint256 public _burnFee = 3;
    uint256 private _previousBurnFee = _burnFee;
    
    //Total 5% => 4% goes to liquidity providers + 1% are added to liquidity pool 
    uint256 public _liquidityFee = 5;
    uint256 private _previousLiquidityFee = _liquidityFee;
    
    //means 20% from total collected liquidity(5% on every Transfer) will be used to rewarded liquidity providers
    uint256 public _lpRewardFromLiquidity = 80;
