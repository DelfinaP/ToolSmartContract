...
// File: interfaces\kanpai\IGovernance.sol
...
// File: contracts\strategies\StrategyKPFIGovernance.txt
...
contract StrategyKPFIGovernance {
    using SafeERC20 for IERC20;
    using Address for address;
    using SafeMath for uint256;

    address public constant want = address(0x6e001E5FC865d11C0Bf88a8dbC0C73F3eD6ce320);
    address public constant gov = address(0x8B188944C7f919093F3D0b77809c4d4c94d94863);
    address public constant curve = address(0xd8B4cd27294aeB5CFFfa24bcAA9432E7d19b71dA);
    address public constant zap = address(0x29178Ed62ae2C56Fc3b8F351D382f6D16a3a84Fb);

    address public constant reward = address(0x02336aB947f189baD0a194a977c4300146545a53);
    ...
    function balanceOfKGov() public view returns (uint256) {
        return IGovernance(gov).balanceOf(address(this));
    }

    function balanceOf() public view returns (uint256) {
        return balanceOfWant().add(balanceOfKGov());
    }
