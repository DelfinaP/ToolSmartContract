 ...
 * @title Lox token
 **/
 contract LOX is StandardBurnableToken, PausableToken {
     
    using SafeMath for uint256;
    string public constant name = "LOX SOCIETY";
    string public constant symbol = "LOX";
    uint8 public constant decimals = 10;
    uint256 public constant INITIAL_SUPPLY = 5e4 * (10 ** uint256(decimals));
