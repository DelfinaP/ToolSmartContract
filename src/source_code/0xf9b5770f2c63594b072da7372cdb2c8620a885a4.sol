...
contract NftRelay is Governance{
    ...
    uint256 public apwr_amount = 4* 1e15;   // 0.004
    ...
    function claimNFTbytokens(  uint256 amount ) external  canClaim()
    {
        ...
        _apwrx.transfer( msg.sender, apwr_amount );
    ...
    function MigrateNFT() external onlyGovernance 
    {
         ...
         if( count >= 1 )
         {
            ...
            ApwrToken _apwrx = ApwrToken(_apwr);
            _apwrx.transfer( _nextRelayPool, apwr_amount );
         }
