...
contract MgasQuery is Ownable {
    ...
    using SafeMath for uint256;
    address public wethAddr = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;// = 0x0d4a11d5eeaac28ec3f61d100daf4d40471f1852;
    address public usdtAddr = 0xdAC17F958D2ee523a2206206994597C13D831ec7;// = 0xdac17f958d2ee523a2206206994597c13d831ec7;
    address public ethUsdtPairAddr = 0x0d4a11d5EEaaC28EC3F61d100daF4d40471f1852;// = 0x0d4a11d5eeaac28ec3f61d100daf4d40471f1852;
    address public manGasPairAddr = 0x5602B452F691143e7029a100c2889bf6d533C12A;// = 0x5602B452F691143e7029a100c2889bf6d533C12A;
    address public manGasAddr = 0x46d5FD4A711B905ea0aaA10db31801efc75dEa56;// = 0x46d5FD4A711B905ea0aaA10db31801efc75dEa56;
    ...
    function usdtFor1Eth() public view returns(uint256) {
        ...
        return usdt.mul(10**12).div(eth); // usdt for 1eth
    }
    ...
    function getManGasAmountWithUsdt(uint256 usdtAmount) public view returns(uint256){ 
        ...
        return usdtAmount.mul(mangasFor1Eth().mul(1000000).div(usdtFor1Eth())).div(1000000);
