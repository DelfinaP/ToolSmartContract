...
/// @notice ArgentXAG is a ERC20 token and it's value equal to one troy ounce (t oz) Silver
/// @dev ArgentXAG is Ownable, Pausable, Burn and Mint controlled by a central SupplyController
...
contract ArgentXAG {
    ...
    string public constant name = "ARGENT"; // solium-disable-line
    string public constant symbol = "XAG"; // solium-disable-line uppercase
    ...
    function reclaimXAG() external onlyOwner {
