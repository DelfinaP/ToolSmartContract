...
contract MainToken is BurnableFreezableMintableToken {
    ...
    uint constant private INITIAL_SUPPLY = 20000000000 * (10 ** uint(DECIMALS));
    string constant private NAME = "Decentralized ID of Things";
    string constant private SYMBOL = "DIDT";
