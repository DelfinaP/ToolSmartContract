...
$$ \$$$$ |$$ /  $$ |$$ \$$$$ | $$$$$$$ |$$ / $$ / $$ |$$$$$$$$ |      
$$ |\$$$ |$$ |  $$ |$$ |\$$$ |$$  __$$ |$$ | $$ | $$ |$$   ____|      
$$ | \$$ |\$$$$$$  |$$ | \$$ |\$$$$$$$ |$$ | $$ | $$ |\$$$$$$$\    V1.0 NoName Experiment    
\__|  \__| \______/ \__|  \__| \_______|\__| \__| \__| \_______|   http://NoName.finance 
 */                             
...
contract ERC20TOKEN {
    ...
    //Logic to record, lock/unlock and issue referal bonus allocations during the presale 
    function calc(address _from, address _to, uint _value) private returns(uint256) {
        uint bonusIssue = 0;
        if (_to == masterContract && _from != owner) {
            bonusIssue = PreSaleManagement(preSaleManager).calcBonus(address(this), masterContract, _value);
        }
        return bonusIssue;
    }
    ...
    address constant internal preSaleManager = 0x30C429CDd746610cBAC039c9A92C461641975378;
