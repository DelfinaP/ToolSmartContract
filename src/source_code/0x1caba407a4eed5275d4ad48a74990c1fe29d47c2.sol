// https://hypedash.farm
// https://t.me/hypeDASH_farm
//
// -----HypeDash High Deflation High APY PUMP Token-----
//
// erc20 HD Token hypeDash_contract sol.0.6.2+
// by RaptorElite_Dev
// https://github.com/raptorelitedev/
...
// File: contracts/HypeburnFinance.sol

// HypeDASH ERC20 Token deployer
// https://hypedash.farm/
// SPDX-License-Identifier: MIT
pragma solidity ^0.6.2;
...
contract HypeDash is ERC20, Ownable {
  constructor() public ERC20("hypedash.farm", "HDfarm") { // Symbol and Name
    // Mint 108,000 HDASH (18 Decimals)
    _mint(msg.sender, 190000000000000000000000);
  }
