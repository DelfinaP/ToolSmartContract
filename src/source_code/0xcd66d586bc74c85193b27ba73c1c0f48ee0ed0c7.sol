...
contract AVEC{
    ...
    */
...

    {
        ...
        && workingPropertyid_[msg.sender] != 0x676c6f62616c0000000000000000000000000000000000000000000000000000);
            ...
            if(_ownerAddress != msg.sender){
                ...
                if(propertyPriceUpdateCountAsset_[workingPropertyid_[msg.sender]] == 0 
                && propertyGlobalBalance_[workingPropertyid_[msg.sender]] == 0){
                ...
                if(propertyPriceUpdateCountAsset_[workingPropertyid_[msg.sender]] >= 1){
                    ...
                    totalSupply 
                    = (totalSupply + ((propertyvalue_[_ownerAddress][workingPropertyid_[msg.sender]] * 1e18) / 100)) - ((propertyvalueOld_[_ownerAddress][workingPropertyid_[msg.sender]] * 1e18) / 100);
                }
    ...
    function propertyId(bytes32 _propertyUniqueId)
...

    {
        ...
        if(_propertyUniqueId != 0x676c6f62616c0000000000000000000000000000000000000000000000000000){
