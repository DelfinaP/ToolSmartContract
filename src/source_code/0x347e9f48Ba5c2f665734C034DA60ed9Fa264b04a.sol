...
/// @title Multivest Token
/// @dev Standard ERC20Burnable token
contract MultivestToken is ERC20Burnable, ERC20Detailed {
    string public constant NAME = "Multivest Token";
    ...
    uint256 public constant INITIAL_SUPPLY = 10**25; // 10 million tokens, 18 decimal places.
