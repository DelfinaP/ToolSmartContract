...
contract Consts {
    string constant TOKEN_NAME = "HCUT";
    string constant TOKEN_SYMBOL = "HCUT";
...
//filename: contracts/tokens/FreezableToken.sol
/**
...
//filename: contracts/tokens/MintableToken.sol
/**
