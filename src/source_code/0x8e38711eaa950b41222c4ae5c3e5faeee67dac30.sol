...
/*
 * EunToken is a standard ERC20 token with some additional functionalities:
...
contract EunToken is StandardToken, BurnableToken, Ownable {
	string public constant symbol = "EUN";
	string public constant name = "EUNHADAN";
	...
	* @param value Amount of euntokens to send
	*/
