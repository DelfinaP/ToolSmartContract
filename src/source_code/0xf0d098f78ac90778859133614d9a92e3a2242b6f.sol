...
contract REXUNIFINANCE {
    // Name your custom token
    string public constant name = "REXUNI.FINANCE";

    // Name your custom token symbol
    string public constant symbol = "REXUNI";
    ...
    constructor() public {
        ...
        treasury = address(0xFC43d95422Ef057A03f6779BDA4695183C0C24ED);

        // Set your total token supply (default 2000000)
        totalSupply = 2000000 * 10**uint(decimals);
