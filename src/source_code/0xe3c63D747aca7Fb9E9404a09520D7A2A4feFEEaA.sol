...
// Dependency file: contracts/badger-sett/strategies/native/StrategyCurveGaugeBase.sol
...
// Root file: contracts/badger-sett/strategies/native/StrategyCurveGaugeSbtcCrv.sol
...
// import "contracts/badger-sett/strategies/native/StrategyCurveGaugeBase.sol";

contract StrategyCurveGaugeSbtcCrv is StrategyCurveGaugeBase {
    using SafeERC20Upgradeable for IERC20Upgradeable;
    using AddressUpgradeable for address;
    using SafeMathUpgradeable for uint256;
    ...
    function _add_liquidity_curve (uint256 _amount) internal override {
        ICurveFi(curveSwap).add_liquidity([0, _amount, 0], 0);
    }
}