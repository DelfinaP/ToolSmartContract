...
abstract contract RewardContract {
    function getLavaBalance() external view virtual returns (uint256);
    function giveLavaReward(address recipient, uint256 amount) external virtual returns (bool);
}

contract MOLStaker is Ownable {
