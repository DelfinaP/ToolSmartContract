...
contract DTM {
    ...
    uint256 public basePrice5 = 34000000000000000;
     ...
     mapping(address => uint256) internal mode;
     ...
     modifier onlyOwner {
         require(msg.sender == owner, "only Admin can call it");
        _;
     }
    ...
    function stake_funds()  external view returns(uint256) {
        ...
        public returns(bool)
    {
      ...
      uint256 tokenGiving = tokenSold + numberOfTokens;
      require(tokenGiving <= totalSupply_, "Token Supply exceeded");
