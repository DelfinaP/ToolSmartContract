...
/**
 * @title Aloha Coin
 * @author Aloha Coin Members
 * @dev Aloha Coin is an ERC223 Token with ERC20 functions and events
 *      Fully backward compatible with ERC20
 */
/*******************************************************************************/

contract ALH is ERC223, Ownable {
...
//
/*******************************************************************************/
    string public name = "Aloha Coin Ver.1.2020";
    string public symbol = "ALH";
    uint8 public decimals = 8;
    uint256 public initialSupply = 5e7 * 1e8;
