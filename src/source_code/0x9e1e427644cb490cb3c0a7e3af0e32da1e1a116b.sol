// Modified for use with SYNC, modifications not made by Zapper
...
contract ZapInModified is ReentrancyGuard, Ownable {
    ...
    */
    ...
    /*
      Calculates the value to put in for minpooltokens. Should not be used in the same transaction as zapIn. Slippage as a fraction of 10000 (1% -> 100, 15% -> 1500, etc.).
    */
