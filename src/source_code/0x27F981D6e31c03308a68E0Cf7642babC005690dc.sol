...
abstract contract AaveMakerStrategy is IStrategy, Pausable {
    ...
    constructor(
        ...
        address aTokenAddress = _getToken(_controller);
    ...
    function _getToken(address _controller) internal view returns (address) {
...
// File: contracts/strategies/AaveMakerStrategyBTC.sol

pragma solidity 0.6.12;

//solhint-disable no-empty-blocks
contract AaveMakerStrategyBTC is AaveMakerStrategy {
    constructor(
        address _controller,
        address _pool,
        address _cm
