/**
 * site: https://nexusfinance.io
 * tweet:  https://twitter.com/nexus_finance
 * telegram: https://t.me/nexus_finance
 * 
 * Nexus is a ERC20 token with:
 * -no minting
 * -public burning
 * -transfer fee applied
 *
 * Nexus will allow Holders to access unique Ethereum farming opportunities,
...
contract NexusFinance is DeflationaryERC20 {

    constructor(uint256 initialTokens) public DeflationaryERC20("NexusFinance", "NEXUS") {
    // symbol        = NEXUS
    // name          = NexusFinance
