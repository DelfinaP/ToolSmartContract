...
// File: contracts/SIRewardDistributor.sol
...
contract SIRewardDistributor is Ownable {
    ...
    function claim(
        ...
        address signatureSigner = ecrecover(prefixedHash, v, r, s);
        ...
        require(
            siToken.balanceOf(address(this)) >= recipient.amount,
            "Insufficient Funds"
        );

        accountNonces[recipient.wallet] += 1;
        siToken.safeTransfer(recipient.wallet, recipient.amount);
