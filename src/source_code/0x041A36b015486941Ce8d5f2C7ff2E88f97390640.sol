...
// File: contracts\LedgisToken.sol

contract Ledgis is ERC20 {
    string public constant name = "Ledgis"; // solium-disable-line uppercase
    string public constant symbol = "LED"; // solium-disable-line uppercase
