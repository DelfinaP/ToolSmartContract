...
contract BeepleCollectionTwo100Edition is ERC721Full {
...
//   mapping (uint => bool) public _IPFSHashHasBeenSet;
   ...
   constructor(
       ...
       contractId = 1;
       numNiftiesCurrentlyInContract = 1;
       baseURI = base_uri;
       ...
       //set names
       _setNiftyTypeName(1, "BEEPLE EVERYDAYS - RAW");
   ...
   function giftNifty(address collector_address, 
    ...
    function massMintTypeNFTs(address collector_address, uint numToMint) onlyOwner public {
        //loop through array and create nifties
        for (uint i=0; i < numToMint; i++) {
            giftNifty(collector_address,1);
        }
