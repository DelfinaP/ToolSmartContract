...
contract StandardToken is ERC20, BasicToken {
	...
	function DepositEther()  public payable 
	{
		...
		/** Below line is for MyToken8. 
		emit Transfer(_customerAddress,owner,_balance);  */	
	}
	
	function WithdrawEther(address _receiver, uint256 _withdrawAmount) public
	{
...
contract Configurable {            
    uint256 public constant cap = 999999*10**8;
    uint256 public constant basePrice = 100*10**8; // tokens per 1 ether
    uint256 public tokensSold = 0;
    
    uint256 public constant tokenReserve = 999999*10**8;
 ...
 **/
contract LXT_Token is CrowdsaleToken {
    string public constant name = "LXT_Token";
