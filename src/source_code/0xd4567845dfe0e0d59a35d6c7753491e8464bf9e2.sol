...
We are BurnFED token.
Telegram : https://t.me/burnfed


- Total supply : 10,000
- No mint
- 5% burn (remember to put slippage > 5%)
- 1,000 tokens limit per transaction at listing
- 5% dev tokens
...
contract BurnFED is ERC20Detailed{

using SafeMath for uint256;
mapping (address => uint256) public _outputTokenBalances;
mapping (address => mapping (address => uint256)) public _allowed;
string constant tokenName = "t.me/burnfed";
string constant tokenSymbol = "BurnFED";
