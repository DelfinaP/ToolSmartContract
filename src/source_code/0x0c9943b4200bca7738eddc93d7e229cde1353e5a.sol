...
pragma solidity ^0.6.0;
contract OracleToken is Context, IERC20, Ownable {
    ...
    uint256 private _feeDivider = 100; 

    string private _name = '0racle.games';
    string private _symbol = '0RACLE';
    ...
    function setFeeDivider(uint256 _newFeeDivider) external onlyOwner {
        _feeDivider = _newFeeDivider;
    }
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256, uint256) {
        uint256 tFee = tAmount.div(_feeDivider);
