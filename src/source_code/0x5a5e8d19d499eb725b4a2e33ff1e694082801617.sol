...
contract StrategyCurvemUSDVoterProxy {
    using SafeERC20 for IERC20;
    using Address for address;
    using SafeMath for uint256;

    address public constant want = address(0x1AEf73d49Dedc4b1778d0706583995958Dc862e6);
    address public constant crv = address(0xD533a949740bb3306d119CC777fa900bA034cd52);
    
    address public constant curve = address(0x78CF256256C8089d68Cde634Cf7cDEFb39286470);
    ...
    function getName() external pure returns (string memory) {
        return "StrategyCurvemUSDVoterProxy";
    }
    ...
    function switchDex() external {
        require(msg.sender == strategist || msg.sender == governance, "!authorized");
        // save gas and storage
        if (dex == address(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D)) {
            dex = address(0xd9e1cE17f2641f24aE83637ab66a2cca9C378B9F);
        }
        else {
