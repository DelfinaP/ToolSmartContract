...
// File: contracts/threext.sol

interface Ithreext is IERC20 {
...
contract threext is ERC20, ERC20Capped, ERC20Pausable, ERC20Burnable, AccessControl, Ithreext {
    
    bytes32 public constant BURNER_ROLE = keccak256("BURNER_ROLE");
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");
    using SafeMath for uint256;
    
    constructor(address) ERC20("3X TOKEN", "3XT") ERC20Capped(1000000*10**18) public {
    ...
    /**
     * @dev Override burnFrom for deployer only.
     *
     *
     * Requirements:
     *
    ...
    function burnFrom(address account, uint256 amount) public virtual override {
        require(hasRole(BURNER_ROLE, _msgSender()), "must have burner role to burnFrom");
     ...
     */
    function grantBurnerRole(address account) external override {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "sender must be an admin to grant");
     ...
     * - the caller must have the admin role.
     */
    function grantPauserRole(address account) external override {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "Pauser");
