...
contract etherATMExcahnge {
    ...
    string constant public _name = "etherATM Exchange";
    string constant public _symbol = "EATM";
    uint8 constant public _decimals = 0;
    uint256 public _totalSupply = 99999;
    uint256 public _rewardsSupply = 9999;
    uint256 public circulatingSupply = 90000;
    ...
    uint256 public commissionPercent = 500;
    uint256 public sellCommission = 500;
    uint256 public tokenCommissionPercent = 250;
    uint256 public buyPrice;
    uint256 public sellPrice;
    uint8 public currentRoadmap = 1;
    uint8 public sellRoadmap = 1;
    uint8 constant public LAST_ROADMAP = 9;
    uint256 public currentRoadmapUsedSupply = 1111;
    uint256 public sellRoadmapUsedSupply = 1111;
    uint256 public totalStakeTokens = 0;
    uint256 public totalLockInTokens = 0;
    uint256 public locakablePercent = 500;
    bool buyLimit = true;
    uint256 buyLimitToken = 1100;
    uint256 minBuyToken = 1;
    ...
    constructor(address _commissionHolder, address _stakeHolder) public {
        ...
        createRoadmap();
        buyPrice = 20000000000000000;
        sellPrice = 20000000000000000;
    }
    ...
    function createRoadmap() private {
        ...
        roadmap = Roadmap({
        supply : 10000,
        startPrice : 0.02667 ether,
        incPrice : 0.0000007778 ether
        });
        ...
        roadmap = Roadmap({
        supply : 10000,
        startPrice : 0.03445 ether,
        incPrice : 0.0000012222 ether
        });
        ...
        roadmap = Roadmap({
        supply : 10000,
        startPrice : 0.04667 ether,
        incPrice : 0.0000013333 ether
        });
        ...
        roadmap = Roadmap({
        supply : 10000,
        startPrice : 0.06000 ether,
        incPrice : 0.0000020000 ether
        });
        ...
        roadmap = Roadmap({
        supply : 10000,
        startPrice : 0.10000 ether,
        incPrice : 0.0000033333 ether
        });
        ...
        roadmap = Roadmap({
        supply : 10000,
        startPrice : 0.14000 ether,
        incPrice : 0.0000066667 ether
        });
        ...
        roadmap = Roadmap({
        supply : 10000,
        startPrice : 0.20000 ether,
        incPrice : 0.000090 ether
        });
