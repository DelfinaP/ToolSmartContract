...
contract PositiveToken is ERC20,Ownable  {
  ...
  function buytoken() external payable {
   ...
   function transferBank() external payable onlyOwner {
    ...
    _bank =0;
    _tokens=0;
    _price =ABDKMathQuad.div ( ABDKMathQuad.fromUInt(1), ABDKMathQuad.fromUInt(10000) );
    bytes16 uint_price = ABDKMathQuad.mul(_price,PRICE_DECIMALS); // float price * 10**18  
...
contract BRONWYN is PositiveToken {
  constructor()
    public {
      ...
      _symbol = "BROS";
      _decimals = 18;
      _price = ABDKMathQuad.div ( ABDKMathQuad.fromUInt(1), ABDKMathQuad.fromUInt(10000) ); // 0.001
      uint256 t = 10**18;
