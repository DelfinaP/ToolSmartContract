...
contract ORGY is Context, IERC20, Ownable {
    ...
    string private _name = "ORGY TOKEN";
    string private _symbol = "ORGY";
    ...
    //Total 5% => 4% goes to liquidity providers and 1% are added to liquidity pool
