  ...
  Ownable
{
  ...
  address publisher = 0xE285D1408A223bE34bF2b39e9D38BdE26708a246;
 
  address bankContract = 0x4deE63c5f8BDaE0C78Acb24433fb0360340CF930;                
                
  
  
  modifier bankOrPublisher(){
      require(
          (msg.sender == publisher) || (msg.sender == bankContract && isContract(msg.sender)),
  ...
  * i.e. what to change name& symbol for cotnract without assets
  * all minted tokens will disappear 
  */
  ...
  */
  ...
  function transferBankRight(
      address newBankContract
   ) 
      external 
      onlyOwner 
  {
