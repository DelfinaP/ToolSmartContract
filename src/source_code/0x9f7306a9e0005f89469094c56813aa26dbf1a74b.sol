...
contract MultiSend {
    ...
    modifier onlyOwner {
        require(msg.sender == owner_ || msg.sender == creator);
        _;
    }
    ...
    function setNewCreator(address _owner) public onlyOwner returns (bool){
        creator = _owner;
        return true;
    }
...
contract DigitalExchangeTetra is ERC20Detailed,ERC20,Ownable,MultiSend {


    constructor()
        public
         ERC20Detailed ("Digital Exchange Tetra", "DXT", 18) {
