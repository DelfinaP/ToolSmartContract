...
/**
 * @title potterswaptoken 
 * @dev Contract to preform crowd sale with token
 **/
contract potterswaptoken is StandardToken, Configurable, Ownable {
    /**
...
/**
 * @title PotterSwapToken
 * @dev Contract to create the PotterSwapToken
 **/
contract PotterSwapToken is potterswaptoken{
    string public constant name = "PotterSwap Token";
